...
function ModalSupport() {
  return (
    <div className="transition-none absolute top-[44px] -left-[41.032px] bg-white rounded-[4px] cursor-pointer flex flex-col outline-none overflow-hidden z-50 shadow-lg  ">
